...
const GaleryOverviewModal = () => {
  ...
  const ImageItem = <Image onClick={(e) => e.stopPropagation()} src={galery} alt='Image Item' width={1000} height={1000} className='w-full hfull max-w-xl max-h-[576px] object-cover' />;
