        ...
        {menus.map((menu) => (
          <>
            <Link key={menu.name} href={menu.link}>
              <li className={`uppercase  text-[13px] cursor-pointer  hover:text-[#121212d9] transition duration-300 ${pathname === menu.link ? 'text-[#121212d9] font-bold' : 'text-[#666666D9]'}`}>{menu.name}</li>
            </Link>
          </>
        ))}
      </ul>
